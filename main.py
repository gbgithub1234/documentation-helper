...
- the problem: document-based information can be scattered in many places\n

- the solution: provide a one-stop shopping resource for all document-based information\n
